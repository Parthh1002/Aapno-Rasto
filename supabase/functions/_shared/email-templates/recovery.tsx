...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your password for Aapno Rasto</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            We received a request to reset your password for Aapno Rasto. Click the button below to choose a new password.
          </Text>
