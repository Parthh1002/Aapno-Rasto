...
export const FluidCursor = () => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-40 overflow-hidden w-full h-full opacity-40 dark:opacity-30 transition-opacity duration-500">
      {/* Saffron Blob */}
      <div
        ref={blob1Ref}
        className="absolute top-[-200px] left-[-200px] w-[400px] h-[400px] rounded-full bg-[hsl(30,100%,60%)] opacity-20 blur-[100px] will-change-transform dark:bg-[hsl(30,100%,50%)]"
      />
      {/* Navy Blue Blob */}
      <div
        ref={blob2Ref}
        className="absolute top-[-250px] left-[-250px] w-[500px] h-[500px] rounded-full bg-[hsl(216,100%,50%)] opacity-20 blur-[120px] will-change-transform dark:bg-[hsl(216,80%,50%)]"
      />
      {/* Green Blob */}
      <div
        ref={blob3Ref}
        className="absolute top-[-150px] left-[-150px] w-[300px] h-[300px] rounded-full bg-[hsl(145,63%,50%)] opacity-15 blur-[80px] will-change-transform dark:bg-[hsl(145,80%,40%)]"
      />
    </div>
  );
};
